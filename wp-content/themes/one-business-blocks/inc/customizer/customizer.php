...
function one_business_blocks_customize_register( $wp_customize ) {
	...
	// Pro Section
 	$wp_customize->add_section('one_business_blocks_pro', array(
        'title'    => __('ONE BUSINESS BLOCKS PREMIUM ', 'one-business-blocks'),
        'priority' => 1,
    ));
    ...
    $wp_customize->add_control(new One_Business_Blocks_Pro_Control($wp_customize, 'one_business_blocks_pro', array(
        'label'    => __('ONE BUSINESS BLOCKS PREMIUM', 'one-business-blocks'),
    ...
    public function render_content(){?>
        <label style="overflow: hidden; zoom: 1;">
	        <div class="col-md upsell-btn">
                <a href="<?php echo esc_url( ONE_BUSINESS_BLOCKS_PRO_LINK ); ?>" target="blank" class="btn btn-success btn"><?php esc_html_e('UPGRADE ONE BUSINESS BLOCKS PREMIUM ','one-business-blocks');?> </a>
	        </div>
            <div class="col-md">
