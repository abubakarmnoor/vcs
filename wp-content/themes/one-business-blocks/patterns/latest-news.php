...
<!-- wp:group {"style":{"border":{"radius":"10px"}},"backgroundColor":"white","className":"blog-box","layout":{"type":"constrained"}} -->
<div class="wp-block-group blog-box has-white-background-color has-background" style="border-radius:10px"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":80,"customOverlayColor":"#000e0d","className":"blog-box","layout":{"type":"constrained"}} -->
